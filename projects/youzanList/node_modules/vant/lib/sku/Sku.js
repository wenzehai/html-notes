...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return !_vm.isSkuEmpty ? _c('popup', { attrs: { "position": "bottom", "lock-on-scroll": "", "prevent-scroll": "" }, model: { value: _vm.show, callback: function callback($$v) {
          _vm.show = $$v;
      ...
      return _c('div', { key: index, staticClass: "van-sku-row-group" }, [_c('sku-row', { attrs: { "sku-event-bus": _vm.skuEventBus, "sku-row": skuTreeItem } }, _vm._l(skuTreeItem.v, function (skuValue, index) {
