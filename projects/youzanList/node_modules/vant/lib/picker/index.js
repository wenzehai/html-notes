...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-picker" }, [_vm.showToolbar ? _c('div', { staticClass: "van-picker__toolbar van-hairline--top-bottom" }, [_vm._t("default", [_c('div', { staticClass: "van-picker__cancel", on: { "click": function click($event) {
          _vm.emit('cancel');
        } } }, [_vm._v(_vm._s(_vm.cancelButtonText || _vm.$t('cancel')))]), _c('div', { staticClass: "van-picker__confirm", on: { "click": function click($event) {
          _vm.emit('confirm');
        } } }, [_vm._v(_vm._s(_vm.confirmButtonText || _vm.$t('confirm')))]), _vm.title ? _c('div', { staticClass: "van-picker__title", domProps: { "textContent": _vm._s(_vm.title) } }) : _vm._e()])], 2) : _vm._e(), _c('div', { staticClass: "van-picker__columns", on: { "touchmove": function touchmove($event) {
