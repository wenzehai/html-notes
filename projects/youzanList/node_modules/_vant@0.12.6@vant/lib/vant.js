...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-f07bed08","hasScoped":false,"preserveWhitespace":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./packages/toast/toast.vue
...
var currentDefaultOptions = extends_default()({}, defaultOptions);
...
var toast_Toast = function Toast() {
  ...
  options = extends_default()({}, currentDefaultOptions, options);
...
toast_Toast.setDefaultOptions = function () {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  currentDefaultOptions = extends_default()({}, currentDefaultOptions, options);
};

toast_Toast.resetDefaultOptions = function () {
  currentDefaultOptions = extends_default()({}, defaultOptions);
};
...
var dialog_currentDefaultOptions = extends_default()({}, dialog_defaultOptions);
...
dialog_Dialog.alert = function (options) {
  return dialog_Dialog(extends_default()({}, dialog_currentDefaultOptions, options));
};

dialog_Dialog.confirm = function (options) {
  return dialog_Dialog(extends_default()({}, dialog_currentDefaultOptions, {
...
dialog_Dialog.setDefaultOptions = function () {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  dialog_currentDefaultOptions = extends_default()({}, dialog_currentDefaultOptions, options);
};

dialog_Dialog.resetDefaultOptions = function () {
  dialog_currentDefaultOptions = extends_default()({}, dialog_defaultOptions);
};
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-238593b2","hasScoped":false,"preserveWhitespace":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./packages/area/index.vue
var area_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('picker',{ref:"picker",staticClass:"van-area",attrs:{"show-toolbar":"","value-key":"name","title":_vm.title,"columns":_vm.columns},on:{"change":_vm.onChange,"confirm":function($event){_vm.$emit('confirm', $event)},"cancel":function($event){_vm.$emit('cancel', $event)}}})}
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6111e940","hasScoped":false,"preserveWhitespace":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./packages/sku/Sku.vue
