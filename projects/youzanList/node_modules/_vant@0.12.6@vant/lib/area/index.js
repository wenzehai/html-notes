...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('picker', { ref: "picker", staticClass: "van-area", attrs: { "show-toolbar": "", "value-key": "name", "title": _vm.title, "columns": _vm.columns }, on: { "change": _vm.onChange, "confirm": function confirm($event) {
  ...
  computed: {
    listValid: function listValid() {
      return this.areaList && (0, _typeof3.default)(this.areaList.province_list) === 'object';
    },
