...
exports.default = (0, _utils.create)({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-picker-column", class: _vm.className, style: _vm.columnStyle, on: { "touchstart": _vm.onTouchStart, "touchmove": function touchmove($event) {
          $event.preventDefault();_vm.onTouchMove($event);
  ...
  methods: {
    ...
    isDisabled: function isDisabled(option) {
      return (typeof option === 'undefined' ? 'undefined' : (0, _typeof3.default)(option)) === 'object' && option.disabled;
    },
    getOptionText: function getOptionText(option) {
      return (typeof option === 'undefined' ? 'undefined' : (0, _typeof3.default)(option)) === 'object' && this.valueKey in option ? option[this.valueKey] : option;
    },
